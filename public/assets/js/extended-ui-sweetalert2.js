!(function () {
    var t = document.querySelector("#basic-alert"),
        ...
        f = document.querySelector("#tada-animation"),
        m = document.querySelector("#shake-animation"),
        ...
        C = document.querySelectorAll("#confirm-text"),
        k = document.querySelectorAll("#confirm-color");
    t &&
        (t.onclick = function () {
            Swal.fire({
        ...
        (o.onclick = function () {
            Swal.fire({
                ...
                customClass: {
                    ...
                    cancelButton:
                        "btn btn-outline-secondary btn-icon waves-effect",
                },
                buttonsStyling: !1,
            });
        }),
                ...
                for (e = 0; e < o.length;) {
                    var n = await new i({
                        ...
                        customClass: {
                            ...
                            denyButton:
                                "btn btn-outline-secondary waves-effect",
                        },
                    });
                    n.value
                        ? ((t[e] = n.value), e++)
        ...
        (C.onclick = function () {
            ...
            Swal.fire({
                ...
                // If the user clicked "No", do nothing (form won't be submitted)
            }).then(function (t) {
                t.value &&
                    Swal.fire({
                        icon: "success",
