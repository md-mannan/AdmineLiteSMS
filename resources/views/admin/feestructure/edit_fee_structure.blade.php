...
@section('title', 'Fee Structure || Update')
@section('CustomCSS')
                                    ...
                                    <div class="row">
                                        <div class="form-group col-4">
                                            ...
                                            <select class="form-control select2bs4 select2-hidden-accessible"
                                                ...
                                                name="class_id">
                                                <option selected="selected" value="{{ $info->class->id }}">
                                                    {{ $info->class->name }}</option>
                                        ...
                                        <div class="form-group col-4">
                                            ...
                                            <select class="form-control select2bs4 select2-hidden-accessible"
                                                style="width: 100%;" data-select2-id="17" tabindex="-1" aria-hidden="true"
                                                name="fee_head_id">
                                                <option selected="selected" value="{{ $info->feeHead->id }}">
                                                    {{ $info->feeHead->name }}</option>
                                        ...
                                        <div class="form-group col-4">
                                            ...
                                            <select class="form-control select2bs4 select2-hidden-accessible"
                                                ...
                                                <option selected="selected" value="{{ $info->academicYear->id }}">
                                                    {{ $info->academicYear->name }}
                                                </option>
